...
<div class="row">
    ...
    <div class="col-6 additional">
        ...
        <div class="form-group blitz">
            ...
            <input type="number" name="outgoing" class="form-control" id="outgoing-field" aria-describedby="outgoing" placeholder="<fmt:message key="lot.field.outgoing.placeholder" />">
        </div>
        <div class="form-group blitz">
            <label for="round-amount-field"><fmt:message key="lot.field.round.amount.label" /></label>
            <input type="number" name="round-amount" class="form-control" id="round-amount-field" aria-describedby="round-amount" placeholder="<fmt:message key="lot.field.round.amount.placeholder" />">
        </div>
        <div class="form-group blitz">
            <label for="round-time-field"><fmt:message key="lot.field.round.time.label" /></label>
            <input type="number" name="round-time" class="form-control" id="round-time-field" aria-describedby="round-time" placeholder="<fmt:message key="lot.field.round.amount.placeholder" />">
        </div>
        <div class="form-group blitz">
            <label for="min-people-field"><fmt:message key="lot.field.min-people.label" /></label>
            <input type="number" name="min-people" class="form-control" id="min-people-field" aria-describedby="min-people" placeholder="<fmt:message key="lot.field.min-people.placeholder" />">
        </div>
        <div class="form-group blitz">
            <label for="max-people-field"><fmt:message key="lot.field.max-people.label" /></label>
            <input type="number" name="max-people" class="form-control" id="max-people-field" aria-describedby="max-people" placeholder="<fmt:message key="lot.field.max-people.placeholder" />">
        </div>
        <div class="form-group blitz internet">
            <label for="blitz-price-field"><fmt:message key="lot.field.blitz-price.label" /></label>
            <input type="number" name="blitz-price" class="form-control" id="blitz-price-field" aria-describedby="blitz-price" placeholder="<fmt:message key="lot.field.blitz-price.placeholder" />">
        </div>
        <div class="form-group english internet">
            <label for="bet-time-field"><fmt:message key="lot.field.bet-time.label" /></label>
            <input type="number" name="bet-time" class="form-control" id="bet-time-field" aria-describedby="bet-time" placeholder="<fmt:message key="lot.field.bet-time.placeholder" />">
        </div>
        <div class="form-group english">
            <label for="step-price-field"><fmt:message key="lot.field.step-price.label" /></label>
            <input type="number" name="step-price" class="form-control" id="step-price-field" aria-describedby="step-price" placeholder="<fmt:message key="lot.field.step-price.placeholder" />">
        </div>
    </div>
</div>
